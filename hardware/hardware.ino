...
void BTN1function(void);
void BTN2function(void);
void BTN3function(void);
...
void loop()
{
  ...
  uint8_t mValue = map(analogRead(analogPin), 0, 1023, 0, 9);
...
void vButtonCheck(void *pvParameters)
{
  ...
  for (;;)
  {
    ...
    {
      // Button 1 is pressed, execute the appropriate function
      BTN1function();
    }
    ...
    {
      // Button 2 is pressed, execute the appropriate function
      BTN2function();
    }
    ...
    {
      // Button 3 is pressed, execute the appropriate function
      BTN3function();
    }
...
void checkPasscode(void)
{
  ...
  if (WiFi.status() == WL_CONNECTED)
  {
    ...
    http.begin(client, "http://10.22.16.191:8080/api/check/combination"); // Your Domain name with URL path or IP address with path
